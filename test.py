...
class Auto(models.Model):
    ...
    distance = models.IntegerField(default=0, blank=True)  # пробег машины с начальным значением 0; необязательное поле;
...
Auto.objects.create(name="Toyota Corolla", model="Toyota", distance=72000)
